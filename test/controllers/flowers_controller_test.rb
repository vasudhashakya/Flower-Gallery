...
class FlowersControllerTest < ActionController::TestCase
  ...
  test "should create flower" do
    assert_difference('Flower.count') do
      post :create, flower: { description: @flower.description, image_url: @flower.image_url, title: @flower.title }
    end
  ...
  test "should update flower" do
    patch :update, id: @flower, flower: { description: @flower.description, image_url: @flower.image_url, title: @flower.title }
    assert_redirected_to flower_path(assigns(:flower))
  end
